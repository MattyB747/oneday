...
const R = [
  ...
  { id: 'la-colombe', name: 'La Colombe', region: 'winelands', lat: -34.0206, lon: 18.4106, cuisine: 'Fine dining', price: 'RRRR', priceText: 'R1200+pp', meal: 'lunch', note: 'World-renowned tasting menu on Silvermist estate — book well ahead.' },
  { id: 'beau-constantia', name: 'Chef’s Warehouse at Beau Constantia', region: 'winelands', lat: -34.0261, lon: 18.4189, cuisine: 'Modern tapas', price: 'RRR', priceText: 'R550–750pp', meal: 'lunch', note: 'Spectacular vineyard views over Constantia.' },
];
